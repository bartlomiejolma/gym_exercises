...
//
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.photoImage.image = exercise.photo
        let formatter = DateFormatter()
        formatter.dateFormat = "EE dd.MM"
    
        cell.lastTrainedValueLabel.text =  formatter.string(from: exercise.lastTrained)
        cell.weightValueLable.text = String(exercise.weight)
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        case "ShowDetail":
            guard let exerciseViewController = segue.destination as? ExerciseViewController else {
    ...
    @IBAction func unwindToExercisesList(sender: UIStoryboardSegue) {
